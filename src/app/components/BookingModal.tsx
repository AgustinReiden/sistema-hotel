...
export default function BookingModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start md:items-center justify-center p-0 md:p-6 bg-slate-950/60 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto">
      <div className="bg-white rounded-none md:rounded-3xl shadow-2xl w-full min-h-full md:min-h-0 md:h-auto md:max-h-[90vh] md:max-w-5xl overflow-y-auto relative flex flex-col md:flex-row">
        {!success && (
          <button
            onClick={onClose}
        ...
        {success ? (
          <div className="p-12 md:p-20 text-center w-full flex flex-col items-center justify-center animate-in zoom-in-95 duration-500">
            ...
            <p className="text-slate-600 text-lg mb-2">
              Tu reserva para la <strong>{room.room_type}</strong> ha sido registrada y esta <span className="text-amber-500 font-bold">pendiente de confirmacion</span>.
            </p>
            <div className="flex items-center gap-3 bg-green-50 border border-green-100 rounded-xl px-6 py-4 mb-4 max-w-md">
              ...
              <p className="text-sm text-green-700 text-left">
                Te vamos a avisar por <strong>WhatsApp</strong> al numero proporcionado cuando tu reserva sea confirmada.
              </p>
            </div>
          ...
          <>
            ...
            <div className="w-full md:w-7/12 p-8 md:p-10 lg:p-12 flex flex-col justify-center bg-white">
