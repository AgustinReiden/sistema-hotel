...
export default function PaymentModal({
    isOpen, onClose, reservationId, clientName, totalPrice, paidAmount, onSuccess
}: PaymentModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await registerPaymentAction(reservationId, parsedAmount, method);
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden relative">
                <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-slate-800">Cargar Pago</h2>
                    ...
                    <form id="payment-form" onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-brand-500 focus:ring focus:ring-brand-200 outline-none transition-all text-xl font-bold text-slate-800"
                                required
                            />
                        </div>
