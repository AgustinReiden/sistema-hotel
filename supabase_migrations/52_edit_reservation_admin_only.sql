-- Migration 52: Editar reserva solo para admin
--
-- El recepcionista no debe poder editar reservas (el UI ya oculta el boton).
-- Defensa en profundidad: se agrega un guard app_is_admin() al inicio de
-- rpc_update_reservation. Se re-crea la version vigente (migracion 34) con la
-- misma firma; solo se suma el chequeo de rol.
